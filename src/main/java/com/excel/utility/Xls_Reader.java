...
public class Xls_Reader {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			//System.out.println("inside reader class"+cell.getCellType().name());
			//
			...
			// return cell.getStringCellValue();
				...
				//System.out.println("inside numeric condition"+cell.getCellType().name());
				//String cellText = String.valueOf(cell.getNumericCellValue());
				String cellText = NumberToTextConverter.toText(cell.getNumericCellValue());
				//System.out.println("value of Mobile"+cellText);
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			System.out.println("inside the reader"+cell.getCellType());
			...
			// return cell.getStringCellValue();
				...
				System.out.println("inside numeric method"+cell.getCellType());
				String cellText = String.valueOf(cell.getNumericCellValue());
				if (HSSFDateUtil.isCellDateFormatted(cell)) {
					// format in form of M/D/YY
					double d = cell.getNumericCellValue();
